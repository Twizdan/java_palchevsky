...
public class fourth_task {
    public static void main(String[] args) throws SQLException {
        ...
        int x = 0;
        String s = " ";
        System.out.println("Введите три строки: две строки и третья для проверки");
        ...
        while (!"7".equals(s)) {
            System.out.println("""
                    ...
                    3. Возвращение подстроки по индексам, результат в MySQL
                    4. Перевод строк в верхний и нижний регистры, результат сохранить в MySQL
            ...
            switch (x) {
                ...
                case 3 -> {
                    System.out.println("Введите индексы для подстроки, от 0 до " + (Math.min(a.length(), b.length())));
                    int ind1 = sc.nextInt();
                    int ind2 = sc.nextInt();
